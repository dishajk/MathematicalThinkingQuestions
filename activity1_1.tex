...
\begin{figure}
    \begin{tikzpicture}
        ...
        \draw[step=.5cm] (2,0) grid (4,4);
        \filldraw (2,0) circle [radius=2pt] --++ (0:1) circle [radius=2pt] --++ (72:1) circle [radius=2pt] --++ (144:1) circle [radius=2pt] --++ (216:1) circle [radius=2pt] --++ (288:1) circle [radius=2pt];

        % \node[regular polygon, regular polygon sides=5, draw, inner sep=0.5cm] at (3,0) {};
        % \node[regular polygon, regular polygon sides=5, draw, inner sep=1cm] at (4,1) {};
        % \draw (0.5,0)-- (0.5,0.5)--++(-30:1)--++(60:1)--++(0:1)--++(-60:1)--++(30:1)--++(-90:0.5);
        % \draw (0,0.5)--(0.5,0.5)--++(60:1)--++(120:1)--++ (180:0.5);
        % \draw (0.5,0.5)++(60:1)--++(-30:1)--++(90:1)--++(0:1)--++(-90:1)--++(30:1)--++(-60:1)--++(0:0.5);
        % \draw (0.5,0.5)++(60:1)--++(30:1)--++(120:1)--++(210:1)--++(90:0.5);
        % \draw (0.5,0.5)++(60:1)++(30:1)++(0:1)--++(-30:1)--++(60:1)--++(0:0.5);
        % \draw (0.5,0.5)++(60:1)++(30:1)++(0:1)--++(60:1)--++(-30:1)--++(90:0.5);
      \end{tikzpicture} 
\end{figure}
